...
appointments = Appointment.create({user_id1:1, user_id2:12, subject:"Finanzieren", active:true, status:"angefragt", date_from:Date.today, date_to:Date.today, time_from:8, time_to:10})
appointments = Appointment.create({user_id1:1, user_id2:11, subject:"Finanzieren", active:true, status:"angefragt", date_from:Date.today, date_to:Date.today, time_from:12, time_to:13})
appointments = Appointment.create({user_id1:1, user_id2:10, subject:"Finanzieren", active:true, status:"angefragt", date_from:Date.today+1, date_to:Date.today+1, time_from:8, time_to:10})
appointments = Appointment.create({user_id1:1, user_id2:9, subject:"Finanzieren", active:true, status:"angefragt", date_from:Date.today+1, date_to:Date.today+1, time_from:9, time_to:10})
appointments = Appointment.create({user_id1:1, user_id2:8, subject:"Finanzieren", active:true, status:"angefragt", date_from:Date.today+2, date_to:Date.today+2, time_from:15, time_to:18})
appointments = Appointment.create({user_id1:1, user_id2:7, subject:"Finanzieren", active:true, status:"angefragt", date_from:Date.today+3, date_to:Date.today+3, time_from:7, time_to:8})
