...
users = User.create({calendar:true, time_from:8, time_to:20, dateofbirth:"12.12.2003", anonymous:false, status:"ok", active:true, email:"horst.wurm@bluewin.ch", password:"password", name:"Horst", lastname:"Wurm", address1:"Hörnliblick 11", address2:"Zezikon", address3:"", superuser:true, webmaster:true, avatar:File.open(path+'ma_1.jpg', 'rb')})
