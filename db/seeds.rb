...
calenders = Calender.create({status:"ok", active:true, vehicle_id:1, user_id:4, date_from:Date.today, date_to:Date.today+1, time_from:10, time_to:12})
calenders = Calender.create({status:"ok", active:true, vehicle_id:1, user_id:4, date_from:Date.today, date_to:Date.today+1, time_from:10, time_to:12})
calenders = Calender.create({status:"ok", active:true, vehicle_id:1, user_id:5, date_from:Date.today+1, date_to:Date.today+2, time_from:10, time_to:11})
calenders = Calender.create({status:"ok", active:true, vehicle_id:2, user_id:5, date_from:Date.today+2, date_to:Date.today+4, time_from:10, time_to:14})
calenders = Calender.create({status:"ok", active:true, vehicle_id:2, user_id:6, date_from:Date.today+4, date_to:Date.today+5, time_from:10, time_to:15})
...
#create some events..
events = Event.create({ev_category_id:1, status:"ok", active:true, user_id:nil, company_id:1, date_from:Date.today, date_to:Date.today+30, name:"Einweihung neue Frischetheke", address1:"", address2:"", address3:"", description:"Neue Theke 100m", avatar:File.open(path+'fischtheke.jpg', 'rb')})
...
events = Event.create({ev_category_id:2, status:"ok", active:true, user_id:1, company_id:nil, date_from:Date.today, date_to:Date.today+30, name:"Grümpelturnier Münsterlingen", address1:"", address2:"", address3:"", description:"Grümpelturnier", avatar:File.open(path+'gruempel.jpg', 'rb')})
...
events = Event.create({ev_category_id:1, status:"ok", active:true, user_id:1, company_id:nil, date_from:Date.today, date_to:Date.today+30, name:"Bandabend Affeltrangen", address1:"", address2:"", address3:"", description:"Grümpelturnier", avatar:File.open(path+'bandabend.jpg', 'rb')})
