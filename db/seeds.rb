...
#create some events..
events = Event.create({ev_category_id:1, status:"ok", active:true, user_id:nil, company_id:1, date_from:Date.today, date_to:Date.today+30, name:"Einweihung neue Frischetheke", address1:"", address2:"", address3:"", description:"Neue Theke 100m"})
...
events = Event.create({ev_category_id:2, status:"ok", active:true, user_id:1, company_id:nil, date_from:Date.today, date_to:Date.today+30, name:"Grümpelturnier Münsterlingen", address1:"", address2:"", address3:"", description:"Grümpelturnier"})
...
events = Event.create({ev_category_id:1, status:"ok", active:true, user_id:1, company_id:nil, date_from:Date.today, date_to:Date.today+30, name:"Bandabend Affeltrangen", address1:"", address2:"", address3:"", description:"Grümpelturnier"})
