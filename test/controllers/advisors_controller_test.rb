...
class AdvisorsControllerTest < ActionController::TestCase
  ...
  test "should create advisor" do
    assert_difference('Advisor.count') do
      post :create, advisor: { grade: @advisor.grade, service_id: @advisor.service_id, user_id: @advisor.user_id }
    end
  ...
  test "should update advisor" do
    patch :update, id: @advisor, advisor: { grade: @advisor.grade, service_id: @advisor.service_id, user_id: @advisor.user_id }
    assert_redirected_to advisor_path(assigns(:advisor))
  end
