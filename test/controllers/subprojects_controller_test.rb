...
class SubprojectsControllerTest < ActionController::TestCase
  ...
  test "should create subproject" do
    assert_difference('Subproject.count') do
      post :create, subproject: { description: @subproject.description, name: @subproject.name, project_id: @subproject.project_id, user_id: @subproject.user_id }
    end
  ...
  test "should update subproject" do
    patch :update, id: @subproject, subproject: { description: @subproject.description, name: @subproject.name, project_id: @subproject.project_id, user_id: @subproject.user_id }
    assert_redirected_to subproject_path(assigns(:subproject))
  end
